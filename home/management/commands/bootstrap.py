...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        add_employee_permission = Permission.objects.get(codename="add_employee", content_type=content_type)
        change_employee_permission = Permission.objects.get(codename="change_employee", content_type=content_type)
        delete_employee_permission = Permission.objects.get(codename="delete_employee", content_type=content_type)
        ...
        team_leader_group.permissions.set([add_employee_permission, change_employee_permission, delete_employee_permission, view_workflow_permission])
        developer_group, _ = Group.objects.update_or_create(name="developers")
        developer_group.permissions.set([change_employee_permission, view_workflow_permission])
